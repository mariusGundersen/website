...
$$
\def\moveIt#1{\htmlData{key=#1}{#1}}
\def\move#1#2{\htmlData{key=#1}{#2}}

\moveIt{v} \, \move{eq}{=} \, \moveIt{T}\moveIt{m}
$$
...
$$
\def\move#1#2{\htmlData{key=#1}{#2}}
\def\arc#1#2{\htmlData{key=#1,motion=arc}{#2}}
...
\stackrel{
  \begin{matrix}
    \move{m_x1}{m_x} & \move{m_y1}{m_y} & \move{one1}{1}
  \end{matrix}
}{
  \begin{matrix}
    \move{s1}{s}     & \move{zero_a}{0} & \move{t_x}{t_x} \\
...
\stackrel{
  ...
  \begin{matrix}
    ...
    \move{zero_c}{0} \move{m_x3}{m_x}  & \move{zero_d}{0} \move{m_y3}{m_y} & \move{one3}{1} \move{onex}{1}
  \end{matrix}
}
$$
